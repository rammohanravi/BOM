<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/MasterPages/Site.master" AutoEventWireup="true" CodeBehind="Design.aspx.cs" Inherits="BOM._Default" %>
        ...
        <HeaderTemplate>
            <table cellspacing="0" rules="all" border="1" width="100%">
                ...
                <tr>
                    ...
                    <th scope="col" rowspan="2" style="width: 20px">ASPZ
                    </th>
